...
class Transaction:
    def __init__(self, amount, sender_public_key, sender_private_key, recipient_public_key):
      self.amount = amount
...
def generate_transaction():
    ...
    sender_private_key = req['senderPrivateKey']
    recipient_public_key = req['recipientAddress']
    amount = req['amount']
